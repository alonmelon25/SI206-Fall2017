...
class KnownValues(unittest.TestCase):
	def test_guesses(self)
		self.assertEqual(one_student.__str__, "Jackie Cohen is in the SI department right now.")
# What is the output of the code print(student2) in the program?
		self.assertEqual(student2.__str__, "Ayo Akonikun is in the SI department right now.")
# What is the output of the code print(student4.likely_credits()) in the program?
		self.assertEqual(student3.__str__, "7")
# What is the output of the code print(student3.likely_credits()) in the program?
		self.assertEqual(student4.__str__, "29")
